...
//Complier:  g++
//File type: Extra Credit Binary Tree implementation file
//================================================================
...
// PURPOSE:  Show elements in POST order traversal from the Root
// This is the same as Depth First Traversal
...
// PURPOSE: Does POST order traversal from V recursively
// PARAM: V is the pointer to the vertex to be visited now
...
void BST::remove(Vertex *V, Vertex *P)
{
  ...
  if (V->Left == NULL && V->Right == NULL)
	...
	delete V;
      ...
      // ** if V has just the right child (case 3)
	else if (V->Left == NULL && V->Right != NULL)
	{
	  cout << "removing a vertex with just the right child" << endl;
	  // ** Make Parent left or right point to the right child and delete V
	   if(P->Left == V)
             P->Left = V->Right;//P's left point to V's right
           else
             P->Right = V->Right; // P's right point to V's right
           delete V;
